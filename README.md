...
It's just a shorthand **if/else** statement that in computer science is called a [ternary operator](https://en.wikipedia.org/wiki/%3F:). <br>Where **if **<pre>(index===0)</pre> change class to active. <br>
